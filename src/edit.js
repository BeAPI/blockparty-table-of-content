...
export default function Edit( { attributes, setAttributes } ) {
  ...
  return (
    <>
      <InspectorControls>
        <PanelBody title={ __( 'Content', 'blockparty-table-of-content' ) }>
          <BaseControl
          ...
          colorSettings={ [
            {
              ...
              label: __( 'Links color', 'blockparty-table-of-content' ),
            },
            {
              value: linksActiveColor,
              onChange: linksActiveColor => setAttributes( { linksActiveColor } ),
              label: __( 'Links active color', 'blockparty-table-of-content' ),
            },
          ] }
        />
        <PanelBody title={ __( 'Scroll behavior', 'blockparty-table-of-content' ) }>
          <ToggleControl
            label={ __( 'Stick to top of screen', 'blockparty-table-of-content' ) }
          ...
          />
          {
            sticky && (
              <>
                <UnitControl
                  label={ __( 'Top distance', 'blockparty-table-of-content' ) }
                  help={ __( 'Distance from the top of the screen when scrolling.', 'blockparty-table-of-content' ) }
                  value={ stickyTop }
                  units={ [
